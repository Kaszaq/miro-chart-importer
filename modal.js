...
async function createTable(initialPosX, initialPosY, projects, minDate, maxDate) {
...
async function createProjects(initialPosX, initialPosY, projects, minDate, maxDate) {
    let widgetsToCreate = [];
    let projectsNamesYShift = initialPosY + DAY_BOX_HEIGHT + MONTH_BOX_HEIGHT + PROJECT_BOX_HEIGHT / 2 + PROJECT_BOX_SPACING;
...
async function createChart(data) {
    ...
    await createTable(x, y, projects, minDate, maxDate);
    await createProjects(x, y, projects, minDate, maxDate);
